...
export default function TranslationEditorPanel(props: TranslationEditorPanelProps) {
  const str = () => props.translationStrings.find(s => s.key === props.selectedKey);
    ...
    <div class="order-1 lg:order-2 bg-white rounded-lg shadow flex-shrink-0 flex flex-col overflow-hidden max-h-[calc(100vh-100px)]">
      {props.selectedKey && str() ? (
              ...
              <div class="space-y-2 mt-2">
                <div class="flex items-center justify-between gap-3">
                  <div class="text-xs text-gray-500">
                    ...
                    <Show when={props.translationValue.length > str()!.sourceValue.length * 1.5}>
                  ...
                  <button
                    ...
                    disabled={!props.translationValue.trim() || props.translationValue === str()!.currentValue}
                  >
                    Save
                  </button>
                </div>
        ...
        <div class="p-8 text-center text-gray-500 flex-1 flex items-center justify-center">
          <div>
            <svg class="w-12 h-12 lg:w-16 lg:h-16 mx-auto mb-2 lg:mb-4 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
            </svg>
            <p class="text-base lg:text-lg">Select a translation string to edit</p>
            <p class="text-xs lg:text-sm text-gray-400 mt-1 lg:mt-2 lg:hidden">Tap the menu to select</p>
          </div>
        </div>
      )}
    </div>
