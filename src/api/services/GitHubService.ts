...
import { RepositoryConfigReader, RepositoryInfo, ConfigReaderError } from '@/lib/services/config-reader.js';
import type { TranslationConfig } from '@/lib/types/config.js';
